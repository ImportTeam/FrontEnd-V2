        ...
        <section id="features" className="py-20 overflow-hidden">
            <div className="container space-y-24">
                ...
                <div className="grid gap-16 lg:grid-cols-2 items-center">
                    ...
                    >
                        <div className="space-y-4">
                            <h2 className="text-4xl font-bold tracking-tight">주요 기능 소개</h2>
                            <div className="inline-block rounded-full bg-orange-100 px-4 py-1.5 text-sm font-medium text-orange-600 dark:bg-orange-900/30 dark:text-orange-400">
                                무료 브라우저 확장 프로그램
                            </div>
                        </div>
                        <h3 className="text-3xl font-bold leading-tight bg-clip-text text-transparent bg-linear-to-r from-orange-500 to-red-600">
                            온라인 결제 상품 결제 전,<br />
                ...
                <div className="grid gap-16 lg:grid-cols-2 items-center">
                    ...
                    >
                        <div className="inline-block rounded-full bg-blue-100 px-4 py-1.5 text-sm font-medium text-blue-600 dark:bg-blue-900/30 dark:text-blue-400">
                            AI 기반 소비 분석 리포트
                        </div>
                ...
                <div className="grid gap-16 lg:grid-cols-2 items-center">
                    <m.div
                        ...
                        className="space-y-8"
                    >
                        <div className="inline-block rounded-full bg-purple-100 px-4 py-1.5 text-sm font-medium text-purple-600 dark:bg-purple-900/30 dark:text-purple-400">
                            전 혜택 자동 추적 및 알림 기능
                        </div>
                        <h3 className="text-3xl font-bold leading-tight">
                            놓치는 혜택 없이,<br />
